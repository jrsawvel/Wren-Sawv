...
# 1jun2016    my $tmp_socket_ssl_version = $IO::Socket::SSL::VERSION;
# 1jun2016    $IO::Socket::SSL::VERSION = undef;
...
# 1jun2016    $IO::Socket::SSL::VERSION = $tmp_socket_ssl_version;
